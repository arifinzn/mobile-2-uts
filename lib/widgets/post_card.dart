...
import 'package:kel7/screens/profile/other_user_profile.dart';
import 'package:kel7/widgets/avatar_view.dart';
import 'package:kel7/widgets/common_widgets.dart';
import 'package:visibility_detector/visibility_detector.dart';

import 'package:kel7/controllers/home_controller.dart';
import 'package:kel7/controllers/post_card_controller.dart';
...
import 'package:kel7/models/post_gallery.dart';
import 'package:kel7/models/post_model.dart';
import 'package:kel7/models/post_search_query.dart';
import 'package:kel7/screens/home/posts.dart';
...
class PostCardState extends State<PostCard> {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      commentAndLikeWidget().hp(AppConstants.horizontalPadding),
      const SizedBox(
        height: 12,
      ),
      commentsCountWidget().hp(AppConstants.horizontalPadding),
      const SizedBox(
        height: 16,
      ),
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          widget.model.totalComment > 0 && widget.model.commentsEnabled
              ? BodyMediumText(
                  ...
                  weight: TextWeight.semiBold,
                  color: AppConstants.grayscale700,
                )
              : Container(),
        ]));
  }
  ...
  Widget viewGifts() {
    ...
    ).setPadding(left: AppConstants.horizontalPadding);
  }
        ...
        children: <Widget>[
          Expanded(
            ...
            child: Row(children: <Widget>[
              ...
              //   style: TextStyle(
              //       fontSize: FontSizes.b2, color: AppConstants.grayscale900),
              //   onSubmitted: (_) {
              //     addNewMessage();
              //   },
              //   onTap: () {},
  ...
  Widget addPostUserInfo() {
    return Row(
      ...
      children: [
        ...
        postTimeView().rp(AppConstants.horizontalPadding),
        SizedBox(
          height: 20,
          width: 20,
  ...
  RichText _convertHashtag(String text) {
    ...
    return RichText(
      ...
      //   style: TextStyle(
      //       color: AppConstants.grayscale900, fontWeight: FontWeight.w900),
  ...
  void openActionPopup() {
    Get.bottomSheet(Container(
      color: AppConstants.cardColor.darken(),
