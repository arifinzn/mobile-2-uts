        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(
                    ...
                    width: 92,
                    child: Container(
                      color: AppConstants.themeColor.withOpacity(0.5),
                      height: 92,
                      width: 92,
                      child: ThemeIconWidget(ThemeIcon.checkMark,
                          size: 45, color: AppConstants.themeColor),
                    ).circular.p(10),
                  )
                      .borderWithRadius(
                          value: 1,
                          radius: 46,
                          color: AppConstants.disabledColor.withOpacity(0.1))
                      .vP25,
                  Heading5Text(
              ...
              ).setPadding(top: 40).hp(AppConstants.horizontalPadding),
            ).topRounded(40),
          ),
        ],
      ),
