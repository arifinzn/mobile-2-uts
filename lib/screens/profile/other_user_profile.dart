...
import 'package:kel7/helpers/enum.dart';
...
import 'package:kel7/widgets/sm_tab_bar.dart';
          ...
          return _profileController.user.value != null
              ? Column(
                  children: [
                    ...
                    statsView().hp(AppConstants.horizontalPadding),
                    const SizedBox(
                      height: 40,
                    ),
                    buttonsView().hp(AppConstants.horizontalPadding)
                  ],
                )
              : Container();
        });
  ...
  Widget buttonsView() {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: AppThemeButton(
              ...
              backgroundColor: _profileController.user.value!.isFollowing
                  ...
                  : AppConstants.themeColor.lighten(0.1),
        ...
        //       child: AppThemeButton(
        //           height: 35,
        //           backgroundColor: AppConstants.cardColor.darken(0.5),
        //           text: chatString.tr,
        //           onPress: () {
