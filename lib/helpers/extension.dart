...
extension ShadowView on Widget {
  Card backgroundCard(
      ...
      Card(
        elevation: 1,
        color: fillColor ?? AppConstants.cardColor,
  ...
  Card backgroundCardWithoutRadius({Color? foregroundColor}) => Card(
      elevation: 1,
      color: foregroundColor ?? AppConstants.cardColor,
      child: this);
      ...
      Container(
          decoration: BoxDecoration(
            border: Border.all(
                ...
                color: borderColor ?? AppConstants.themeColor),
            color: fillColor,
            borderRadius: BorderRadius.all(Radius.circular(radius!)),
            boxShadow: <BoxShadow>[
              BoxShadow(
...
extension BorderView on Widget {
  Container border({required double value, Color? color}) => Container(
        decoration: BoxDecoration(
          ...
          border: Border.all(
              width: value, color: color ?? AppConstants.disabledColor),
        ),
        child: this,
      );
  ...
  Widget borderWithRadius({
    ...
    Color? color,
      ...
      Container(
          decoration: BoxDecoration(
            border: Border.all(
                width: value, color: color ?? AppConstants.dividerColor),
            borderRadius: BorderRadius.all(Radius.circular(radius)),
          ),
...
extension AppChip on Widget {
  Widget makeChip({Color? backGroundColor}) => Container(
        color: backGroundColor ?? AppConstants.themeColor.withOpacity(0.2),
        child: setPadding(
