                ...
                border: widget.showBorder == true
                    ? Border.all(
                        ...
                        color: widget.isError == true
                            ? AppConstants.red
                            : widget.borderColor ?? AppConstants.dividerColor)
                    : null,
              ),
              child: Row(
                children: [
                    ...
                    child: Focus(
                      child: TextField(
                        ...
                        style: TextStyle(
                            ...
                            color: AppConstants.inputFieldTextColor),
  ...
  Widget iconView() {
    return widget.icon != null
        ? ThemeIconWidget(widget.icon!,
                color: widget.iconColor ?? AppConstants.iconColor, size: 20)
            .rP16
        : Container();
  }
}
...
class _PasswordFieldState extends State<PasswordField> {
                    ...
                    child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintStyle: TextStyle(
                              fontSize: FontSizes.b3,
                              color:
                                  AppConstants.inputFieldPlaceholderTextColor),
                          border: InputBorder.none,
                          floatingLabelBehavior: FloatingLabelBehavior.never,
                        )),
                    onFocusChange: (hasFocus) {
  ...
  Widget iconView() {
    return widget.icon != null
        ? ThemeIconWidget(
            widget.icon!,
            color: widget.iconColor ?? AppConstants.themeColor,
            size: 20,
          ).rP16
        : Container();
  }
                ...
                Expanded(
                  child: BodySmallText(
                          ...
                          color: widget.defaultText == null
                              ? AppConstants.inputFieldPlaceholderTextColor
                              : AppConstants.inputFieldTextColor)
                      .ripple(() async {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        border: showBorder == true
            ? Border.all(
                width: 0.5, color: borderColor ?? AppConstants.dividerColor)
            : null,
      ),
      height: 60,
      child: Row(children: [
  ...
  Widget iconView() {
    return icon != null
        ? ThemeIconWidget(icon!,
                color: iconColor ?? AppConstants.themeColor, size: 20)
            .rP16
        : Container();
  }
}
